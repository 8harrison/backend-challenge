...
const description = `Will, a blacksmith, joins forces with Captain Jack Sparrow, a pirate, to rescue the love of his life from 
...
export { genres, directors, actors, description, film };
